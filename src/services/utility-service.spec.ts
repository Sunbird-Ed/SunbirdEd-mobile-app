...
describe('UtilityService', () => {
    ...
    describe('openPlayStore()', () => {
        it('should delegate to openPlayStore plugin', (done) => {
            ...
            utilityService.openPlayStore('SOME_ID').then(() => {
                // assert
                expect(window['buildconfigreader']['openPlayStore']).toHaveBeenCalledWith('SOME_ID', expect.any(Function), expect.any(Function));
                done();
            });
        });
   ...
   describe('checkAppAvailability()', () => {
    it('should delegate to checkAppAvailability Method', (done) => {
        // arrange
        (window['buildconfigreader']['checkAppAvailability'] as jest.Mock).mockImplementation((SOME_PACKAGENAME, successCallback, errorCallback) => {
            setTimeout(() => {
                successCallback();
            });
        });
        ...
        utilityService.checkAppAvailability('SOME_PACKAGENAME').then(() => {
            // assert
            expect(window['buildconfigreader']['checkAppAvailability']).toHaveBeenCalledWith('SOME_PACKAGENAME', expect.any(Function), expect.any(Function));
            done();
        });
    });
   ...
   describe('getDownloadDirectoryPath()', () => {
    it('should delegate to getDownloadDirectoryPath Method', (done) => {
        ...
        utilityService.getDownloadDirectoryPath().then(() => {
            // assert
            expect(window['buildconfigreader']['getDownloadDirectoryPath']).toHaveBeenCalledWith( expect.any(Function), expect.any(Function));
            done();
        });
    });
   ...
   describe('exportApk()', () => {
    it('should delegate to exportApk Method', (done) => {
        // arrange
        (window['buildconfigreader']['exportApk'] as jest.Mock).mockImplementation(( successCallback, errorCallback) => {
            setTimeout(() => {
                successCallback();
            });
        });
        ...
        // act
        utilityService.exportApk().then(() => {
            // assert
            expect(window['buildconfigreader']['exportApk']).toHaveBeenCalledWith( expect.any(Function), expect.any(Function));
            done();
        });
    });
    ...
    it('should reject if exportApk string for corresponding entryString was not found', (done) => {
        ...
        // act
        utilityService.exportApk().catch(() => {
            // assert
           expect(window['buildconfigreader']['exportApk']).toReturnWith(undefined);
            done();
        });
    });
   ...
   describe('readFileFromAssets()', () => {
    it('should delegate to readFileFromAssets Method', (done) => {
        // arrange
        (window['buildconfigreader']['readFromAssets'] as jest.Mock).mockImplementation(( SOME_FILENAME, successCallback, errorCallback) => {
            setTimeout(() => {
                successCallback();
            });
        });
        ...
        utilityService.readFileFromAssets('SOME_FILENAME').then(() => {
            // assert
            expect(window['buildconfigreader']['readFromAssets']).toHaveBeenCalledWith( "SOME_FILENAME", expect.any(Function), expect.any(Function));
            done();
        });
    });
   ...
   describe('rm()', () => {
    it('should delegate to rm Method', (done) => {
        // arrange
        (window['buildconfigreader']['rm'] as jest.Mock).mockImplementation(( SOME_DIRPATH, SOME_DIRTOSKIP , successCallback, errorCallback) => {
            setTimeout(() => {
                successCallback();
            });
        });
        ...
        utilityService.rm('SOME_DIRPATH','SOME_DIRTOSKIP').then(() => {
            // assert
            expect(window['buildconfigreader']['rm']).toHaveBeenCalledWith( 'SOME_DIRPATH', 'SOME_DIRTOSKIP', expect.any(Function), expect.any(Function));
            done();
        });
    });
