export const urlConstants = {
  ...
  API_URLS: {
    ...
    GET_PROJECTS: 'v1/userProjects/getProject?page=' /* (deprecated) */,
    ...
    GET_IMAGE_UPLOAD_URLS: 'v1/userProjects/getFileUploadUrl',/*deprecated*/
    ...
    // survey api
    GET_PROG_SOL_FOR_OBSERVATION: 'v1/observations/getObservation' /* (deprecated) */,
    ...
    EDIT_OBSERVATION_NAME: 'v1/observationSubmissions/title/' /* (deprecated) */,
    OBSERVATION_SUBMISSION_DELETE: 'v1/observationSubmissions/delete/' /* (deprecated) */,
    ...
    MAP_ENTITY_TO_OBSERVATION: 'v1/observations/addEntityToObservation/' /* (deprecated) */,
    UNMAP_ENTITY_TO_OBSERVATION: 'v1/observations/removeEntityFromObservation/' /* (deprecated) */,
    ...
    OBSERVATION_MAKE_SUBMISSION: 'v1/observationSubmissions/make/' /* (deprecated) */,
    ...
    SURVEY_FEEDBACK: {
      ...
      SURVEY_LISTING: 'v1/surveys/getSurvey' /* (deprecated) */,
