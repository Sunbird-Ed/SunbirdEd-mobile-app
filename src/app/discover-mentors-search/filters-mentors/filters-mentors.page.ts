...
import {
  ContentService, ContentSearchResult, SearchType
} from '@project-sunbird/sunbird-sdk';
import { ContentUtil } from '../../../util/content-util';
import { FormAndFrameworkUtilService } from '../../../services/formandframeworkutil.service';

@Component({
  selector: 'app-filters-mentors',
  templateUrl: './filters-mentors.page.html',
  styleUrls: ['./filters-mentors.page.scss']
})
export class FiltersMentorsPage implements OnInit, OnDestroy {
  ...
  async openFilterOptions(facet) {
    ...
    this.telemetryGeneratorService.generateInteractTelemetry(InteractType.TOUCH,
      ...
      Environment.HOME,
      (this.source && this.source.match('mentors')) ? PageId.COURSE_SEARCH_FILTER : PageId.LIBRARY_SEARCH_FILTER,
      undefined,
      values);
    await popUp.present();
