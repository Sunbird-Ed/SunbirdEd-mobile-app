...
import { FiltersMentorsPage } from './filters-mentors.page';
...
import { mockFilterCriteria } from './filters-mentors.page.spec.data';
describe('FiltersPage', () => {
  let filtersPage: FiltersMentorsPage;
  ...
  beforeAll(() => {
    filtersPage = new FiltersMentorsPage(
