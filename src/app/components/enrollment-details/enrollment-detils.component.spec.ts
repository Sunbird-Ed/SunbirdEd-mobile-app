...
describe('enrollmentdetailcomponent', () => {
    ...
    it('#resumeCourse should call saveContext publish close and putString', () => { 
        // arrange
        const content = {
            userId: 'userId',
            courseId: 'courseId',
    ...
    it('#resumeCourse should call navigate', (done) => {
        // arrange
        const content = {
            userId: 'userId',
            courseId: 'courseId',
    ...
    it('#enrollIntoBatch should go to enrollment success callback', (done) => {
        // arrange
        const content = {
            userId: 'userId',
            courseId: 'courseId',
    ...
    it('#enrollIntoBatch should go to navigateToDetailPage and call navigate, content.contentId to "contentId"', (done) => {
        // arrange
        const content = {
            userId: 'userId',
            courseId: 'courseId',
    ...
    it('#enrollIntoBatch should go to navigateToDetailPage set content.contentId to "courseId"', (done) => {
        // arrange
        const content = {
            userId: 'userId',
            courseId: 'courseId',
    ...
    it('#enrollIntoBatch should fail and dismiss loader', (done) => {
        // arrange
        const loader = {
            present: jest.fn(),
            dismiss: jest.fn()
    ...
    it('#getUserid should set userToken and isGuestUser', (done) => {
        // arrange
    ...
    it('#navigateToDetailPage should set type to "Course"', () => {
        // arrange
        const content = {
            userId: 'userId',
            contentId: 'courseId',
